...
function buildRemindersInfoHtml(regularReminders, spreadsheetId) {
  ...
  return `
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:20px 0;">
      <tr>
        <td style="background:#f5f5f0;padding:16px 20px;border-left:4px solid #8a8a5c;border-radius:8px;font-family:sans-serif;">
          <p style="margin:0;font-size:15px;font-weight:bold;color:#555530;">Regular Reminders</p>
          ${remindersList}
